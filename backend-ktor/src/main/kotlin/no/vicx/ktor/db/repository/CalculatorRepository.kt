...
class CalculatorRepository {
    suspend fun save(calcEntry: CalcEntry): CalcEntry =
        suspendTransaction {
            CalcEntryTable
                .insertAndGetId { row ->
    ...
    suspend fun findAllIdsByUsername(username: String): Set<Int> =
        suspendTransaction {
            CalcEntryTable
    ...
    suspend fun deleteAllByCreatedAtBeforeAndUsernameNull(createdAt: OffsetDateTime): Int =
        suspendTransaction {
