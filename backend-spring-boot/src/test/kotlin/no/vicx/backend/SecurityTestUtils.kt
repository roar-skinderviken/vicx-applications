...
object SecurityTestUtils {
    ...
    private const val VALID_JWT_STRING =
    ...
    fun createPrincipalInTest(roles: List<String>): OAuth2AuthenticatedPrincipal =
        object : OAuth2AuthenticatedPrincipal {
            override fun getAttributes(): Map<String, Any> = emptyMap()

            override fun getAuthorities(): List<SimpleGrantedAuthority> = roles.map(::SimpleGrantedAuthority)
